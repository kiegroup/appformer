...
/**
 * A descriptor for a {@link Step} that exists in a {@link DescriptorRegistry} at conversion-time.
 *
 * @see Step
 * @see AppFlow
 * @see AppFlowDescriptor
 */
public interface StepReferenceDescriptor extends StepDescriptor, HasIdentifier {
