...
/**
 * Base interface for descriptors of {@link AppFlow#transitionTo(java.util.function.Function) transitions}.
 * 
 * @see PredicateTransitionDescriptor
 * @see OptionalTransitionDescriptor
 * @see CommandTransitionDescriptor
 */
