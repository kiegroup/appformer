...
public class DataModelerServiceImpl
    ...
    @Inject
    private LiveSparkModelLoaderCache classLoaderCache;
    ...
    private ClassLoader getProjectClassLoader(KieProject project) {
    	...
    	classLoader = classLoaderCache.getClassLoader(project);
    	if (classLoader != null) {
    		return classLoader;
    	}
    	
        final KieModule module = builderCache.assertBuilder(project).getKieModuleIgnoringErrors();
        classLoader = KieModuleMetaData.Factory.newKieModuleMetaData(module).getClassLoader();
        classLoaderCache.setClassLoader(project, classLoader);
        return classLoader;
    }
