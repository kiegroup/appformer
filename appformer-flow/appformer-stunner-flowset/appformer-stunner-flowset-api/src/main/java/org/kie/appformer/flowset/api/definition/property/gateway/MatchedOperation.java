...
package org.kie.appformer.flowset.api.definition.property.gateway;

import org.jboss.errai.common.client.api.annotations.Portable;
import org.jboss.errai.databinding.client.api.Bindable;
import org.kie.appformer.flowset.api.definition.FlowProperty;
...
public class MatchedOperation implements FlowProperty {

    @Caption
    @FieldLabel
    public static final transient String caption = "Matched operation";

    @Description
    public static final transient String description = "The gateway's matched operation";
    ...
    @DefaultValue
    public static final transient String defaultValue = "NONE";
    ...
    public MatchedOperation(final String value) {
        this.value = value;
    }
