...
package org.kie.appformer.flowset.api.definition.property.form;
...
public class PropertyExpression implements FlowProperty {

    @Caption
    @FieldLabel
    public static final transient String caption = "Property expression";
    ...
    public PropertyExpression(final String value) {
        this.value = value;
    }
