...
package org.kie.appformer.flowset.client.editor;
...
public class FlowDiagramEditor extends AbstractProjectDiagramEditor<FlowDiagramResourceType> {
    ...
    public static final String EDITOR_ID = "FlowDiagramEditor";

    @Inject
    public FlowDiagramEditor(final View view,
                             final PlaceManager placeManager,
                             final ErrorPopupPresenter errorPopupPresenter,
                             final Event<ChangeTitleWidgetEvent> changeTitleNotificationEvent,
                             final SavePopUpPresenter savePopUpPresenter,
                             final FlowDiagramResourceType resourceType,
    ...
    protected int getCanvasWidth() {
        return (int) FlowGraphFactory.GRAPH_DEFAULT_WIDTH;
    }

    @Override
    protected int getCanvasHeight() {
        return (int) FlowGraphFactory.GRAPH_DEFAULT_HEIGHT;
    }
