 ...
 */
package org.kie.appformer.formmodeler.codegen.util;
...
public interface SourceGenerationUtil {
    ...
    public static final String FORM_MODEL_CLASS = "org.kie.appformer.formmodeler.rendering.client.shared.FormModel";
    public static final String FORM_VIEW_CLASS = "org.kie.appformer.formmodeler.rendering.client.view.FormView";
    public static final String LIST_VIEW_CLASS = "org.kie.appformer.formmodeler.rendering.client.view.ListView";
    ...
    public static final String LIST_VIEW_DELETE_EXECUTOR = "org.kie.appformer.formmodeler.rendering.client.view.ListView.DeleteExecutor";

    public static final String ENTITY_SERVICE_CLASS = "org.kie.appformer.formmodeler.rendering.server.rest.BaseEntityService";

    public static final String BASE_REST_SERVICE = "org.kie.appformer.formmodeler.rendering.client.shared.AppFormerRestService";
    ...
    public static final String SUBFORM_ClASSNAME = "org.kie.appformer.formmodeler.rendering.client.shared.fields.SubFormModelAdapter";

    public static final String MULTIPLE_SUBFORM_ADAPTER_SUFFIX = "MultipleSubFormModelAdapter";
    public static final String MULTIPLE_SUBFORM_ClASSNAME = "org.kie.appformer.formmodeler.rendering.client.shared.fields.MultipleSubFormModelAdapter";
