...
public class MultipleSubFormTemplateProvider extends AbstractTemplateProvider {
    ...
    @Inject
    public MultipleSubFormTemplateProvider( final FieldManager fieldManager ) {
        super( fieldManager );
    }
    ...
    protected String getTemplateForFieldTypeCode( final String fieldCode ) {
        return "/org/kie/appformer/formmodeler/codegen/view/impl/html/templates/multiplesubform.mv";
    }
}
