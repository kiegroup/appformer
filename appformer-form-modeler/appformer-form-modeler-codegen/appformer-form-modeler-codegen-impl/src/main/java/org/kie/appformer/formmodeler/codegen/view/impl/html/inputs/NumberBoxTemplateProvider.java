...
@Dependent
public class NumberBoxTemplateProvider extends AbstractTemplateProvider {

    @Inject
    public NumberBoxTemplateProvider(final FieldManager fieldManager) {
        super(fieldManager);
    }
    ...
    protected String[] getSupportedFieldCodes() {
        return new String[]{
                IntegerBoxFieldDefinition.FIELD_TYPE.getTypeName(),
                DecimalBoxFieldDefinition.FIELD_TYPE.getTypeName()
        };
    }

    @Override
    protected String getTemplateForFieldTypeCode(final String fieldCode) {
        return "/org/kie/appformer/formmodeler/codegen/view/impl/html/templates/numberbox.mv";
    }
}
