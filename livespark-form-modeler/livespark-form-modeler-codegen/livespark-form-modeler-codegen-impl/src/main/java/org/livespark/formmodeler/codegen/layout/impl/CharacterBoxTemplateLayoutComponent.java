 ...
 */
public class CharacterBoxTemplateLayoutComponent implements FormLayoutTemplateComponent {
    @Override
    ...
    public String getDraggableType() {
        return "org.livespark.formmodeler.editor.client.editor.fields.CharacterBoxLayoutComponent";
    }
}
