 ...
 */
public class BigIntegerBoxTemplateLayoutComponent implements FormLayoutTemplateComponent {
    @Override
    ...
    public String getDraggableType() {
        return "org.livespark.formmodeler.editor.client.editor.fields.BigIntegerBoxLayoutComponent";
    }
}
