 ...
 */
public class FloatBoxTemplateLayoutComponent implements FormLayoutTemplateComponent {
    @Override
    ...
    public String getDraggableType() {
        return "org.livespark.formmodeler.editor.client.editor.fields.FloatBoxLayoutComponent";
    }
}
