 ...
 */
public class DateBoxTemplateLayoutComponent implements FormLayoutTemplateComponent {
    @Override
    ...
    public String getDraggableType() {
        return "org.livespark.formmodeler.editor.client.editor.fields.DateBoxLayoutComponent";
    }
}
