...
import org.livespark.formmodeler.editor.client.editor.mock.MockNotificationContextEvent;
...
//        when( formDefinitionResourceType.accept(path) ).thenReturn(false);
        ...
        editorContext = new FormEditorHelper( new MockFieldManager(), new MockNotificationContextEvent() , new ServiceMock(), beanManager);
