...
public class FieldPropertiesGeneratorManager {
    ...
    @PostConstruct
    protected void init() {
        Collection<IOCBeanDef<FieldPropertiesGenerator>> generators = iocBeanManager.lookupBeans(FieldPropertiesGenerator.class);
        for (IOCBeanDef<FieldPropertiesGenerator> generatorDef : generators) {
