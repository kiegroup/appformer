...
package org.uberfire.ext.experimental.service;
...
public class BackendExperimentalFeaturesRegistryServiceTest {
    ...
    public void setup() throws IOException {
        ...
        defRegistry.register(new TestExperimentalFeatureDefinition(FEATURE_1, FEATURE_1, FEATURE_1));
        defRegistry.register(new TestExperimentalFeatureDefinition(FEATURE_2, FEATURE_2, FEATURE_2));
        defRegistry.register(new TestExperimentalFeatureDefinition(FEATURE_3, FEATURE_3, FEATURE_2));
    }
